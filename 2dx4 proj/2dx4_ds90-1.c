// Jaskaran Dhillon, 400189244, dhillj19, 30MHz, PN0 Onboard LED, PL5 for external LED
#include <stdint.h>
...
void PortN0_Init(void){  //Port D2 will be used as the onboard LED
...
if ((count+1)%64 == 0) //blink onboard LED every 45 degrees
  ...
  GPIO_PORTN_DATA_R = 0b000000001; //onboard LED ON
  SysTick_Wait10ms(10);	
	GPIO_PORTN_DATA_R = 0b000000000; //offboard LED OFF
	}
}
count = 0;
